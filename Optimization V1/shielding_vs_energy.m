function [eV, eff] = shielding_vs_energy(r_maj, AR, r_H, varargin)
...
geom = coil_rectangle(r_maj, AR, 33); 
...
%         'I', I, 'KE', eV(ii), 'N', 128, 'rel', 'on', 'thresh', 3); 
